...
const PROFILE_OVERRIDES: Record<string, Partial<ExerciseTrackingProfile>> = {
  ...
  'Chest Lift': { ...SUPINE_PROFILE, mode: 'manual', engageThreshold: 0.12, returnThreshold: 0.05 },
  'Dead Bug': { ...SUPINE_PROFILE, mode: 'manual', landmarks: [11, 12, 15, 16, 23, 24, 25, 26, 27, 28], engageThreshold: 0.13, returnThreshold: 0.055 },
  'Femur Arcs': { ...SUPINE_PROFILE, landmarks: [23, 24, 25, 26, 27, 28], minVisibleLandmarks: 4, engageThreshold: 0.11, returnThreshold: 0.045 },
  'Bent Knee Opening': { ...SUPINE_PROFILE, mode: 'manual', landmarks: [23, 24, 25, 26, 27, 28], minVisibleLandmarks: 4, engageThreshold: 0.1, returnThreshold: 0.04 },
  'Supine Knee Sways': { ...SUPINE_PROFILE, engageThreshold: 0.13, returnThreshold: 0.055 },
  'Arm Arcs': { ...SUPINE_PROFILE, mode: 'manual', landmarks: [11, 12, 13, 14, 15, 16, 23, 24], minVisibleLandmarks: 5, engageThreshold: 0.12, returnThreshold: 0.05 },
  ...
  'Side Kick': { ...SIDE_LYING_PROFILE, mode: 'manual', engageThreshold: 0.14, returnThreshold: 0.055 },
